...
function renderPicPlot(tMDBdata) {
  ...
  // const releaseDate = (document.getElementById("releaseDate").innerText = `Release Date: ${tMDBdata.results[0].release_date}`);
...
function renderMovieWithoutPlot(oMDBnoPlot) {
    // const poster = document.getElementById("moviePoster").src = oMDBnoPlot.;
    console.log('hi')
}
